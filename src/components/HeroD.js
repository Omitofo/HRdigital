    ...
    return (
        <div className={styles.banner}>
            ...
            <div className={styles.slider}>
                <div className={styles.item} style={{ '--position': 1 }}><img src={SunPic} alt="sun" /></div>
                <div className={styles.item} style={{ '--position': 2 }}><h2 className={styles.words}>Welcome</h2></div>
                <div className={styles.item} style={{ '--position': 3 }}><img src={Planet1} alt="planet" /></div>
                <div className={styles.item} style={{ '--position': 4 }}><h2 className={styles.words}>Bienvenido</h2></div>
                <div className={styles.item} style={{ '--position': 5 }}><img src={SunPic} alt="sun" /></div>
                <div className={styles.item} style={{ '--position': 6 }}><h2 className={styles.words}>欢迎 </h2></div>
                <div className={styles.item} style={{ '--position': 7 }}><img src={Planet1} alt="planet" /></div>
                <div className={styles.item} style={{ '--position': 8 }}><h2 className={styles.words}>Willkommen</h2></div>
                <div className={styles.item} style={{ '--position': 9 }}><img src={SunPic} alt="sun" /></div>
                <div className={styles.item} style={{ '--position': 10 }}><h2 className={styles.words}>ようこそ</h2></div>
                <div className={styles.item} style={{ '--position': 11 }}><img src={Planet1} alt="planet" /></div>
                <div className={styles.item} style={{ '--position': 12 }}><h2 className={styles.words}>ようこそ</h2></div>
                <div className={styles.item} style={{ '--position': 13 }}><img src={Planet1} alt="planet" /></div>
            ...
            <div className={styles.declaration}>
                <h3 className={styles.declarationtext}>I AM HERE TO CONQUER. OBEY, OR PERISH!</h3>
            </div>
